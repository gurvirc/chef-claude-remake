...
const client= new InferenceClient(process.env.HF_API_KEY)
    ...
    const SYSTEMSPROMPT = `You are an assistant that receives a list of ingredients that a user has and
        suggests a recipe they could make with some or all of those ingredients and you also provide if it is easy, medium or hard to make in the difficulty field. You don't need to
